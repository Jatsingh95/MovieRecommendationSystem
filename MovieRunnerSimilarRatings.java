...
public class MovieRunnerSimilarRatings {
    ...
    public void printAverageRatings()
    {
        ...
        ArrayList<Rating> AverageRatings = fr.getAverageRatings(10);
    ...
    public void printSimilarRatings()
    {
        ...
        ArrayList<Rating> wRatings = fr.getSimiliarRatings("71", 20, 5);
    ...
    public void printSimilarRatingsByGenre()
    {
        ...
        ArrayList<Rating> wRatings = fr.getSimiliarRatingsByFilter("964",20,5,f);
        System.out.println(MovieDatabase.getTitle(wRatings.get(0).getItem()));
    }
    ...
    public void printSimilarRatingsByDirector()
    {
        ...
        ArrayList<Rating> wRatings = fr.getSimiliarRatingsByFilter("120",10,2,f);
        System.out.println(MovieDatabase.getTitle(wRatings.get(0).getItem()));
    }
    ...
    public void printSimilarRatingsByGenreAndMinutes()
    {
        ...
        f.addFilter(gf);
        f.addFilter(mf);
        ArrayList<Rating> wRatings = fr.getSimiliarRatingsByFilter("168",10,3,f);
        System.out.println(MovieDatabase.getTitle(wRatings.get(0).getItem()));
    }
    ...
    public void printSimilarRatingsByYearAndMinutes()
    {
        ...
        f.addFilter(gf);
        f.addFilter(mf);
        ArrayList<Rating> wRatings = fr.getSimiliarRatingsByFilter("314",10,5,f);
        System.out.println(MovieDatabase.getTitle(wRatings.get(0).getItem()));
    }
}
